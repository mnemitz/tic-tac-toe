...
var G__1543 = o;
(G__1543[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__1544__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__1544 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1545__i = 0, G__1545__a = new Array(arguments.length -  0);
while (G__1545__i < G__1545__a.length) {G__1545__a[G__1545__i] = arguments[G__1545__i + 0]; ++G__1545__i;}
  args = new cljs.core.IndexedSeq(G__1545__a,0,null);
} 
return G__1544__delegate.call(this,args);};
G__1544.cljs$lang$maxFixedArity = 0;
G__1544.cljs$lang$applyTo = (function (arglist__1546){
var args = cljs.core.seq(arglist__1546);
return G__1544__delegate(args);
});
G__1544.cljs$core$IFn$_invoke$arity$variadic = G__1544__delegate;
return G__1544;
})()
;
} else {
...
var G__1547 = o;
(G__1547[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__1552 = props;
var G__1552__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__1552,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__1552);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1552__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__1553){
...
var props = map__1554__$1;
var class$ = cljs.core.get.call(null,map__1554__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__1554,map__1554__$1,props,class$){
return (function (c){
...
});})(map__1554,map__1554__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__1556){
...
var on_write = cljs.core.get.call(null,map__1557__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__1557,map__1557__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__1557,map__1557__$1,on_write))
);
} else {
...
var G__1560 = jsprops;
(G__1560["defaultValue"] = value);

(G__1560["onChange"] = ((function (G__1560,v,value,on_change){
return (function (p1__1559_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__1559_SHARP_);
});})(G__1560,v,value,on_change))
);
...
var vec__1563 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__1563,(0),null);
var id = cljs.core.nth.call(null,vec__1563,(1),null);
var class$ = cljs.core.nth.call(null,vec__1563,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___1567 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___1567 == null)){
} else {
var key_1568 = temp__4661__auto___1567;
(jsprops["key"] = key_1568);
}
...
var temp__4661__auto___1569 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___1569 == null)){
} else {
var key_1570 = temp__4661__auto___1569;
reagent.impl.template.oset.call(null,jsprops,"key",key_1570);
}
...
var G__1571 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__1571["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq1574){
var G__1575 = cljs.core.first.call(null,seq1574);
var seq1574__$1 = cljs.core.next.call(null,seq1574);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1575,seq1574__$1);
});
...
break;
default:
var G__1581 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__1581;
continue;
...
var n__4408__auto___1583 = a.length;
var i_1584 = (0);
while(true){
if((i_1584 < n__4408__auto___1583)){
(a[i_1584] = reagent.impl.template.as_element.call(null,(a[i_1584])));

var G__1585 = (i_1584 + (1));
i_1584 = G__1585;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___1586 = a.length;
var i_1587 = (0);
while(true){
if((i_1587 < n__4408__auto___1586)){
var val_1588 = (a[i_1587]);
if(((cljs.core.vector_QMARK_.call(null,val_1588)) && ((reagent.impl.template.key_from_vec.call(null,val_1588) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_1587] = reagent.impl.template.as_element.call(null,val_1588));

var G__1589 = (i_1587 + (1));
i_1587 = G__1589;
continue;
} else {
}
...
var ctx = ({});
var vec__1590 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__1590,(0),null);
var derefed = cljs.core.nth.call(null,vec__1590,(1),null);
...
var G__1593 = (cljs.core.count.call(null,argv) - first_child);
switch (G__1593) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__1593){
